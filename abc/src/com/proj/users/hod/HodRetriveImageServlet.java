 ...
 */
@WebServlet("/HodRetriveImageServlet")
public class HodRetriveImageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HodRetriveImageServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			PreparedStatement ps=con.prepareStatement("select pic from hod where uname=?");
