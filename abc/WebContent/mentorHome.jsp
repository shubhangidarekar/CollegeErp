                            ...
                            <div class="table-responsive">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                     <%
                                     int count1=1;
                                     int mid= Integer.parseInt((String)session.getAttribute("mid").toString());
                                     con=DBClass.DBConnectMethod();
                                    ps=con.prepareStatement("select * from message where reciverid=?");
                                    System.out.println("Reciver id for message is "+(String)session.getAttribute("mid").toString());
                                ps.setInt(1,mid);
