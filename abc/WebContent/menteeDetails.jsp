            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                      ...
                      <li>
                        <a  href="mentorHome.jsp"><i class="glyphicon glyphicon-comment"></i>Messages</a>
                   </li>
                                 ...
                                 <%
                                  ...
                                  int count=1;
                                    ...
                                    while(rs.next()){	%>
	                                    ...
	                                    <td><a href="Messages.jsp?senderid=<%=rs.getInt(1)%>&recivername=<%=rs.getString("menteename") %>&reciverid=<%=rs.getString("menteeid")%>" class="btn btn-warning"><i class="glyphicon glyphicon-comment"></i></a></td>
	                                  </tr>
	                                     
	      <%--     <td><a href="Messages.jsp?senderid=<%=rs.getInt("reciverid")%>&reciverid=<%=rs.getString("senderid") %>" class="btn btn-success"><i class="glyphicon glyphicon-comment"></i></a></td>  </tr>
