...
<head>
						...
						<!-- 
						  this page is for editing mentor profile only
						 -->
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                   ...
                   <li>
                        <a  href="Messagesonly.jsp"><i class="glyphicon glyphicon-comment"></i>Messages</a>
                   </li>	
                               ...
                               String domainFromMentor="";
                               	...
                               	String dname=(String)session.getAttribute("dept");
                               		...
                               		if(rs.next()){
                               		 ...
                               		 <form role="form" method="post" action="MentorRegisterServlet"  enctype="multipart/form-data"  style="margin-left:105px;">
                               		  <input type="hidden" value= "<%=uname%>" name="uname">
	                       	  		  <input type="hidden" value=<%-- "<%=password %>" --%> name="password">
	                       	 	      
	                       	 	      <div class="form-group">
                                       <label>First Name</label>
                                      <input class="form-control" value="<%=fnameFromMentor %>"name="fname"/>
                                      <input type="hidden" value="<%=session.getAttribute("uid") %>">
                                      <label>Last Name</label>
                                      <input class="form-control" value="<%= lnameFromMentor%>" name="lname"/>
                                      
                                      <label>Phone</label>
                                      <input class="form-control" value="<%=phnFromMentor %> " name="phn"/>
                                      
                                      <label>Email</label>
                                      <input class="form-control" value="<%=emailFromMentor %>" name="email"  type="email"/>
                                      
                                       <label>Domain</label> 
                                        <input class="form-control" value="<%=rs.getString(10)%>"  name="domain" />
                                     <%--   <%
                                       	if(domainFromMentor!=null){%>
                                       		   <input class="form-control" value="<%=rs.getString(10)%>"  name="domain" />
                                       ...
                                       <%}
                                       		 ...
                                       		 <select class="form-control"  name="domain">
                                                        ...
                                                        <option>ComputerSecurity</option>
                                    		 </select>
